...
main()
{
    ...
    mkdir -p ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext/openchat
    cp ${repoDir}/zm-build/openchat.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext/openchat
    cp ${repoDir}/zm-build/zal.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext/openchat
    cp ${repoDir}/zm-build/com_zextras_chat_open.zip ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext/openchat
